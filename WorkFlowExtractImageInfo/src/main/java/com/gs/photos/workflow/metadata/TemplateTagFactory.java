...
public class TemplateTagFactory {
	...
	protected static Map<Tag, Class<? extends AbstractTemplateTag>> convertTagToTemplate = new HashMap<Tag, Class<? extends AbstractTemplateTag>>() {
		{
			this.put(TiffTag.EXIF_SUB_IFD,
					ExifTagTagTemplate.class);
			this.put(TiffTag.GPS_SUB_IFD,
					GpsTagTemplate.class);
			this.put(ExifTag.EXIF_INTEROPERABILITY_OFFSET,
					InteropTagTemplate.class);
			this.put(TiffTag.SUB_IFDS,
	...
	public static AbstractTemplateTag create(Tag ftag, IFD parent, SimpleAbstractField<?> saf) {
		...
		if (cl != null) {
			try {
				Constructor<? extends AbstractTemplateTag> constructor = cl.getDeclaredConstructor(Tag.class,
						IFD.class,
						SimpleAbstractField.class);
				return constructor.newInstance(ftag,
						parent,
						saf);
			} catch (
	...
	public static AbstractTemplateTag create(Tag tag) {
		return new DefaultTagTemplate(tag);
	}
