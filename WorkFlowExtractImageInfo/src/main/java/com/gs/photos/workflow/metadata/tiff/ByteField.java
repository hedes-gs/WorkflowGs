...
public final class ByteField extends TiffField<byte[]> {
	...
	public ByteField(Tag tag, SimpleAbstractField<byte[]> underLayingField, short tagValue) {
		super(tag, underLayingField, tagValue);
	}

	@Override
	public String getDataAsString() {
		return StringUtils.byteArrayToHexString(underLayingField.getData(), 0, 10);
	}
}