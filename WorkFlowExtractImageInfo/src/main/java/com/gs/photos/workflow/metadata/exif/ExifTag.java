...
public enum ExifTag implements Tag {
    EXPOSURE_TIME(
        ...
        public String getFieldAsString(Object value) {
            ...
            return "F" + StringUtils.rationalToString(df,
                true,
                intValues);
        }
    },
    ...
    SHUTTER_SPEED_VALUE(
        ...
        public String getFieldAsString(Object value) {
            ...
            // formatting numbers up to 2 decimal places in Java
            DecimalFormat df = new DecimalFormat("#,###,###.##");
            return StringUtils.rationalToString(df,
                false,
                intValues);
        }
    },
    ...
    public static Tag fromShort(short value) {
        ExifTag exifTag = ExifTag.tagMap.get(value);
        if (exifTag == null) {
    ...
    static {
        for (ExifTag exifTag : ExifTag.values()) {
            ExifTag.tagMap.put(exifTag.getValue(),
                exifTag);
        }
    }
