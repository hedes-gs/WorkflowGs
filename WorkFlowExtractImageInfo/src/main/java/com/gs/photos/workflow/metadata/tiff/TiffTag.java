...
public enum TiffTag implements Tag {
	DATE_TIME_ORIGINAL("date time original", (short) 0x9003, Attribute.PRIVATE), CREATE_DATE_TIME("create date time ",
			(short) 0x9004, Attribute.PRIVATE), OFFSET_TIME("offset date time ", (short) 0x9010,
					Attribute.PRIVATE), OFFSET_TIME_ORIGNAL("offset time original", (short) 0x9011,
							Attribute.PRIVATE), OFFSET_TIME_DIGITIZED("offset time digitized", (short) 0x9012,
									Attribute.PRIVATE), FOCAL_LENGTH("focal length", (short) 0x920A,
											Attribute.PRIVATE), FOCAL_LENGTH_IN_35_MM("focal length in 35mm",
													(short) 0xA405, Attribute.PRIVATE), OWNER_NAME("Owner name",
															(short) 0xA430, Attribute.PRIVATE), LENS_MODEL(
																	"Lens model	", (short) 0xA434, Attribute.PRIVATE),

	THUMB_JPEG("thumb jpg", (short) 0xfffe, Attribute.PRIVATE),
	...
	ORIENTATION("Orientation", (short) 0x0112, Attribute.BASELINE) {
		@Override
		public String getFieldAsString(Object value) {
			String[] values = { "TopLeft", "TopRight", "BottomRight", "BottomLeft", "LeftTop", "RightTop",
	...
	PAGE_NAME("Page Name", (short) 0x011D, Attribute.EXTENDED), X_POSITION("XPosition", (short) 0x011E,
			Attribute.EXTENDED), Y_POSITION("YPosition", (short) 0x011F, Attribute.EXTENDED),
	...
	WHITE_POINT("White Point", (short) 0x013E, Attribute.EXTENDED), PRIMARY_CHROMATICITIES("PrimaryChromaticities",
			(short) 0x013F, Attribute.EXTENDED),
	...
	BAD_FAX_LINES("Bad Fax Lines", (short) 0x0146, Attribute.EXTENDED), CLEAN_FAX_DATA("Clean Fax Data", (short) 0x0147,
			Attribute.EXTENDED), CONSECUTIVE_BAD_FAX_LINES("ConsecutiveBadFaxLines", (short) 0x0148,
					Attribute.EXTENDED),
	...
	EXIF_PRIVATE_TAGS("Sony/Adobe DNG/Pentax tags", (short) 0xc634, Attribute.PRIVATE) {
		@Override
		public FieldType getFieldType() {
			return FieldType.IFD;
		}
	},
	...
	INK_NAMES("Ink Names", (short) 0x014D, Attribute.EXTENDED), NUMBER_OF_INKS("Number Of Inks", (short) 0x014E,
			Attribute.EXTENDED), DOT_RANGE("Dot Range", (short) 0x0150,
					Attribute.EXTENDED), TARGET_PRINTER("Target Printer", (short) 0x0151, Attribute.EXTENDED),
	...
	S_MIN_SAMPLE_VALUE("S Min Sample Value", (short) 0x0154, Attribute.EXTENDED), S_MAX_SAMPLE_VALUE(
			"S Max Sample Value", (short) 0x0155, Attribute.EXTENDED), TRANSFER_RANGE("Transfer Range", (short) 0x0156,
					Attribute.EXTENDED), CLIP_PATH("Clip Path", (short) 0x0157, Attribute.EXTENDED), X_CLIP_PATH_UNITS(
							"X Clip Path Units", (short) 0x0158, Attribute.EXTENDED), Y_CLIP_PATH_UNITS(
	...
	FAX_PROFILE("Fax Profile", (short) 0x0192, Attribute.EXTENDED) {
		@Override
		public String getFieldAsString(Object value) {
			String[] values = { "Does not conform to a profile defined for TIFF for facsimile",
					"Minimal black & white lossless, Profile S", "Extended black & white lossless, Profile F",
					"Lossless JBIG black & white, Profile J", "Lossy color and grayscale, Profile C",
	...
	DECODE("Decode", (short) 0x01B1, Attribute.EXTENDED), DEFAULT_IMAGE_COLOR("Default Image Color", (short) 0x01B2,
			Attribute.EXTENDED),
	...
	JPEG_INTERCHANGE_FORMAT_LENGTH("JPEG Interchange Format Length/Jpeg IF Byte Count", (short) 0x0202,
			Attribute.EXTENDED) {
		@Override
		public FieldType getFieldType() {
			return FieldType.LONG;
	...
	RATING("Rating", (short) 0x4746, Attribute.PRIVATE), RATING_PERCENT("Rating Percent", (short) 0x4749,
			Attribute.PRIVATE),
	...
	IT8_SITE("IT8 Site", (short) 0x84e0, Attribute.PRIVATE), IT8_COLOR_SEQUENCE("IT8 Color Sequence", (short) 0x84e1,
			Attribute.PRIVATE), IT8_HEADER("IT8 Header", (short) 0x84e2, Attribute.PRIVATE), IT8_RASTER_PADDING(
					"IT8 Raster Padding", (short) 0x84e3,
					Attribute.PRIVATE), IT8_BITS_PER_RUN_LENGTH("IT8 Bits Per Run Length", (short) 0x84e4,
							Attribute.PRIVATE), IT8_BITS_PER_EXTENDED_RUN_LENGTH("IT8 Bits Per Extended Run Length",
									(short) 0x84e5, Attribute.PRIVATE), IT8_COLOR_TABLE("IT8 Color Table",
											(short) 0x84e6,
											Attribute.PRIVATE), IT8_IMAGE_COLOR_INDICATOR("IT8 Image Color Indicator",
													(short) 0x84e7, Attribute.PRIVATE), IT8_BKG_COLOR_INDICATOR(
															"IT8 Bkg Color Indicator", (short) 0x84e8,
															Attribute.PRIVATE), IT8_IMAGE_COLOR_VALUE(
																	"IT8 Image Color Value", (short) 0x84e9,
																	Attribute.PRIVATE), IT8_BKG_COLOR_VALUE(
																			"IT8 Bkg Color Value", (short) 0x84ea,
																			Attribute.PRIVATE), IT8_PIXEL_INTENSITY_RANGE(
																					"IT8 Pixel Intensity Range",
																					(short) 0x84eb,
																					Attribute.PRIVATE), IT8_TRANSPARENCY_INDICATOR(
																							"IT8 Transparency Indicator",
																							(short) 0x84ec,
																							Attribute.PRIVATE), IT8_COLOR_CHARACTERIZATION(
																									"IT8 Color Characterization",
																									(short) 0x84ed,
																									Attribute.PRIVATE), IT8_HC_USAGE(
																											"IT8 HC Usage",
																											(short) 0x84ee,
																											Attribute.PRIVATE),
