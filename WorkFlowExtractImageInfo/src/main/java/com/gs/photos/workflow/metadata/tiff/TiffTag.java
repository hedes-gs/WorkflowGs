...
public enum TiffTag implements Tag {
    ...
    NEW_SUBFILE_TYPE(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.LONG; }
    },
    ...
    SUBFILE_TYPE(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.SHORT; }
    },
    ...
    COMPRESSION(
        ...
        @Override
        public String getFieldAsString(Object value) {
            return TiffFieldEnum.Compression.fromValue(((int[]) value)[0])
                .getDescription();
        }
    ...
    PHOTOMETRIC_INTERPRETATION(
        ...
        @Override
        public String getFieldAsString(Object value) {
            return TiffFieldEnum.PhotoMetric.fromValue(((int[]) value)[0])
                .getDescription();
        }
    ...
    FILL_ORDER(
        ...
        public String getFieldAsString(Object value) {
            ...
            int intValue = ((int[]) value)[0];
            if ((intValue != 1) && (intValue != 2)) { return "Warning: unknown fill order value: " + intValue; }
    ...
    DOCUMENT_NAME(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.ASCII; }
    },
    ...
    ORIENTATION(
        ...
        public String getFieldAsString(Object value) {
            String[] values = {
                    "TopLeft", "TopRight", "BottomRight", "BottomLeft", "LeftTop", "RightTop", "RightBottom",
                    "LeftBottom" };
            int intValue = ((int[]) value)[0];
            if ((intValue >= 1) && (intValue <= 8)) { return values[intValue - 1]; }
    ...
    X_RESOLUTION(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.RATIONAL; }
    },
    ...
    PLANAR_CONFIGURATTION(
        ...
        @Override
        public String getFieldAsString(Object value) {
            return TiffFieldEnum.PlanarConfiguration.fromValue(((int[]) value)[0])
                .getDescription();
        }
    ...
    GRAY_RESPONSE_UNIT(
        ...
        public String getFieldAsString(Object value) {
            //
            String[] values = {
                    "Number represents tenths of a unit", "Number represents hundredths of a unit",
            ...
            int intValue = ((int[]) value)[0];
            if ((intValue >= 1) && (intValue <= 5)) { return values[intValue - 1]; }
    ...
    SUB_IFDS(
        ...
        @Override
        public boolean mayContainSomeSimpleFields() { return true; }
    ...
    EXIF_PRIVATE_TAGS(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.IFD; }
    },
    ...
    EXTRA_SAMPLES(
        ...
        public String getFieldAsString(Object value) {
            // We only has three values for this tag, so we use an array instead of a map
            String[] values = {
                    "Unspecified data", "Associated alpha data (with pre-multiplied color)",
                    "Unassociated alpha data" };
            int intValue = ((int[]) value)[0];
            if ((intValue >= 0) && (intValue <= 2)) { return values[intValue]; }
    ...
    SAMPLE_FORMAT(
        ...
        public String getFieldAsString(Object value) {
            String[] values = {
                    "Unsigned integer data", "Two's complement signed integer data", "IEEE floating point data",
                    "Undefined data format", "Complex integer data", "Complex IEED floating point data" };
            int intValue = ((int[]) value)[0];
            if ((intValue >= 1) && (intValue <= 6)) { return values[intValue - 1]; }
    ...
    JPEG_TABLES(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.UNDEFINED; }
    },
    ...
    FAX_PROFILE(
        ...
        public String getFieldAsString(Object value) {
            ...
            int intValue = ((int[]) value)[0];
            if ((intValue >= 0) && (intValue <= 6)) { return values[intValue]; }
    ...
    VERSION_YEAR(
        ...
        @Override
        public FieldType getFieldType() { return FieldType.BYTE; }
    },
