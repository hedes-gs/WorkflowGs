...
public class IgniteWrapper implements IgniteCache<String, byte[]> {
    ...
    public IgniteWrapper(Ignite beanIgnite) { this.beanIgnite = beanIgnite; }
    ...
    public void loadAll(
        ...
        this.igniteCache.loadAll(keys, replaceExistingValues, completionListener);
    }
    ...
    public void loadCache(IgniteBiPredicate<String, byte[]> p, Object... args) throws CacheException {
        this.createIgniteCache();
        this.igniteCache.loadCache(p, args);
    }
    ...
    public IgniteFuture<Void> localLoadCacheAsync(IgniteBiPredicate<String, byte[]> p, Object... args)
        throws CacheException {
        this.createIgniteCache();
        return this.igniteCache.localLoadCacheAsync(p, args);
    }

    @Override
    public byte[] getAndPutIfAbsent(String key, byte[] val) throws CacheException, TransactionException {
        this.createIgniteCache();
        return this.igniteCache.getAndPutIfAbsent(key, val);
    }
    ...
    public IgniteFuture<byte[]> getAndPutIfAbsentAsync(String key, byte[] val)
        ...
        this.createIgniteCache();
        return this.igniteCache.getAndPutIfAbsentAsync(key, val);
    }
    ...
    public boolean isLocalLocked(String key, boolean byCurrThread) {
        this.createIgniteCache();
        return this.igniteCache.isLocalLocked(key, byCurrThread);
    }
    ...
    public <T, R> QueryCursor<R> query(Query<T> qry, IgniteClosure<T, R> transformer) {
        this.createIgniteCache();
        return this.igniteCache.query(qry, transformer);
    }
    ...
    public byte[] localPeek(String key, CachePeekMode... peekModes) {
        this.createIgniteCache();
        return this.igniteCache.localPeek(key, peekModes);
    }
    ...
    public long sizeLong(int partition, CachePeekMode... peekModes) throws CacheException {
        this.createIgniteCache();
        return this.igniteCache.sizeLong(partition, peekModes);
    }

    @Override
    public IgniteFuture<Long> sizeLongAsync(int partition, CachePeekMode... peekModes) throws CacheException {
        this.createIgniteCache();
        return this.igniteCache.sizeLongAsync(partition, peekModes);
    }
    ...
    public long localSizeLong(int partition, CachePeekMode... peekModes) {
        this.createIgniteCache();
        return this.igniteCache.localSizeLong(partition, peekModes);
    }

    @Override
    public <T> Map<String, EntryProcessorResult<T>> invokeAll(
        Map<? extends String, ? extends EntryProcessor<String, byte[], T>> map,
        Object... args
    ) throws TransactionException {
        this.createIgniteCache();
        return this.igniteCache.invokeAll(map, args);
    }
    ...
    public <T> IgniteFuture<Map<String, EntryProcessorResult<T>>> invokeAllAsync(
        ...
        this.createIgniteCache();
        return this.igniteCache.invokeAllAsync(map, args);
    }
    ...
    public boolean putIfAbsent(String key, byte[] val) throws TransactionException {
        this.createIgniteCache();
        return this.igniteCache.putIfAbsent(key, val);
    }

    @Override
    public IgniteFuture<Boolean> putIfAbsentAsync(String key, byte[] val) {
        this.createIgniteCache();
        return this.igniteCache.putIfAbsentAsync(key, val);
    }
    ...
    public <T> T invoke(String key, EntryProcessor<String, byte[], T> entryProcessor, Object... arguments)
        throws TransactionException {
        this.createIgniteCache();
        return this.igniteCache.invoke(key, entryProcessor, arguments);
    }

    @Override
    public <T> IgniteFuture<T> invokeAsync(
        String key,
        EntryProcessor<String, byte[], T> entryProcessor,
        Object... arguments
    ) throws TransactionException {
        this.createIgniteCache();
        return this.igniteCache.invokeAsync(key, entryProcessor, arguments);
    }
    ...
    public <T> IgniteFuture<T> invokeAsync(
        String key,
        CacheEntryProcessor<String, byte[], T> entryProcessor,
        Object... arguments
    ) throws TransactionException {
        this.createIgniteCache();
        return this.igniteCache.invokeAsync(key, entryProcessor, arguments);
    ...
    public <T> Map<String, EntryProcessorResult<T>> invokeAll(
        ...
        this.createIgniteCache();
        return this.igniteCache.invokeAll(keys, entryProcessor, args);
    }
    ...
    public <T> IgniteFuture<Map<String, EntryProcessorResult<T>>> invokeAllAsync(
        ...
        this.createIgniteCache();
        return this.igniteCache.invokeAllAsync(keys, entryProcessor, args);
    }
    ...
    @Override
    public IgniteCache<String, byte[]> withReadRepair() {
        this.createIgniteCache();
        return this.igniteCache.withReadRepair();
    }

    @Override
    public void preloadPartition(int partition) {
        this.createIgniteCache();
        this.igniteCache.preloadPartition(partition);
    }

    @Override
    public IgniteFuture<Void> preloadPartitionAsync(int partition) {
        this.createIgniteCache();
        return this.igniteCache.preloadPartitionAsync(partition);
    }

    @Override
    public boolean localPreloadPartition(int partition) {
        this.createIgniteCache();
        return this.igniteCache.localPreloadPartition(partition);
    }
