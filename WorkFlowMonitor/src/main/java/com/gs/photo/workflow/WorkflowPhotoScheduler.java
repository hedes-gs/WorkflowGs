...
public class WorkflowPhotoScheduler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(WorkflowPhotoScheduler.class);
    ...
    public void init() {
        ...
        kafkaStreams.start();
        WorkflowPhotoScheduler.LOGGER.info(
            "started kafka gttreams {} ",
            this.kafkaStreamsTopology.describe()
                .toString());
        Runtime.getRuntime()
