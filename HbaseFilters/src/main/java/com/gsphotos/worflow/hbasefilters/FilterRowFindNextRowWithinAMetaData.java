...
public class FilterRowFindNextRowWithinAMetaData extends FilterBase {
    ...
    public FilterRowFindNextRowWithinAMetaData(
        byte[] keyByteArray,
    ...
    public FilterRowFindNextRowWithinAMetaData() { super(); }
    ...
    public boolean filterRowKey(byte[] data, int offset, int length) {
        ...
        if (!this.nextRowIsFound) {
            byteArrayIsEqual = FilterRowFindNextRowWithinAMetaData
                .compareByteArrays(data, offset, this.keyByteArray, 0, this.lengthOfMetaDataKey);
            if (!byteArrayIsEqual) {
                this.nextRowIsFound = !FilterRowFindNextRowWithinAMetaData
    ...
    public static Filter createFilterFromArguments(ArrayList<byte[]> filterArguments) {
        ...
        return new FilterRowFindNextRowWithinAMetaData(keyByteArray,
            lengthOfMetaDataKey,
            offsetOfImageId,
            lengthOfImageId);
    }
     ...
     * @see #toByteArray
     */
    public static FilterRowFindNextRowWithinAMetaData parseFrom(final byte[] pbBytes) throws DeserializationException {
        ...
        return new FilterRowFindNextRowWithinAMetaData(proto.getKeyByteArray()
