...
public final class IFD {
	...
	/**
	 * Create a children map for sub IFDs. A sub IFD is associated with a tag of the
	 * current IFD which serves as pointer to the sub IFD.
	 */
	 ...
	 * <p>
	 * Note: This should <em>ONLY</em> be called after the current IFD has been
	 * written to the RandomAccessOutputStream
	 *
	 * @param os
	 *            RandomAccessOutputStream
	 * @param nextOffset
	 *            next IFD offset value
	 * @throws IOException
	 */
	 ...
	 *            RandomAccessOutputStream
	 * @param offset
	 *            stream offset to write this IFD
	 *
	 * @throws IOException
	 */
	public int write(RandomAccessOutputStream os, int offset) throws IOException {
		...
		/*
		 * Set the stream position at the end of the IFD to update next IFD offset
		 */
		os.seek(offset);
		os.writeInt(0); // Set next IFD offset to default 0

		// Write sub IFDs if any (we assume bare-bone sub IFDs pointed by long field
		// type with no image data associated)
		if (children.size() > 0) {
