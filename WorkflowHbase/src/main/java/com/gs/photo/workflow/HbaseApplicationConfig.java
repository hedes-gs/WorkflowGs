...
public class HbaseApplicationConfig extends AbstractApplicationConfig {
    ...
    public Consumer<String, HbaseData> consumerToRecordExifDataOfImages(
        ...
        settings.put(
            ...
            "tr-" + applicationId + "-" + HbaseApplicationConfig.CONSUMER_EXIF_DATA_OF_IMAGES);
        settings.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
        settings
            .put(ConsumerConfig.GROUP_ID_CONFIG, groupId + "-" + HbaseApplicationConfig.CONSUMER_EXIF_DATA_OF_IMAGES);
        settings.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, "false");
        settings.put(
            ConsumerConfig.ISOLATION_LEVEL_CONFIG,
            IsolationLevel.READ_COMMITTED.toString()
