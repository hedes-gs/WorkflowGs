...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ProducerFactory<String, byte[]> producerArrayOfbytesFactory(
        @Value("${bootstrap.servers}") String bootstrapServer,
        @Value("${group.id}") String groupId
    ) {
        Map<String, Object> configProps = new HashMap<>();
    ...
    @Bean("kafkaByteArrayTemplate")
    public KafkaTemplate<String, byte[]> kafkaByteArrayTemplate(
        @Value("${bootstrap.servers}") String bootstrapServer,
        @Value("${group.id}") String groupId

    ) {
        return new KafkaTemplate<>(this.producerArrayOfbytesFactory(bootstrapServer, groupId));
    }
