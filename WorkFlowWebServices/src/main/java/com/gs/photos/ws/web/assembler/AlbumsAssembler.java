...
@Component
public class AlbumsAssembler extends RepresentationModelAssemblerSupport<String, EntityModel<String>> {
    ...
    public AlbumsAssembler() { super(ImageController.class,
        AlbumsAssembler.getClassForConstructor()); }

    @Override
    public EntityModel<String> toModel(String entity) {
        AlbumsAssembler.FACTORY.setUriComponentsContributors(Arrays.asList(this.pageableResolver));
        ...
        try {
            return new EntityModel<String>(entity,
                AlbumsAssembler.FACTORY.linkTo(
